...
/*
    Если делать тупым перебором, то:

    1) Определяем, на каком уровне находятся эти вершины через BFS.
    2) Далее, надо запустить поиск от той, что на более высоком уровне и от всех её родителей.\

    Сложность такого решения O(N * H), где H - высота.
*/
